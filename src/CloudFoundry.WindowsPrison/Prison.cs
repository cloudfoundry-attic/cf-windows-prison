namespace CloudFoundry.WindowsPrison
{
    ...
    public class Prison : PrisonModel, IDisposable
    {
        ...
        internal CloudFoundry.WindowsPrison.Utilities.WindowsJobObjects.JobObject jobObject = null;
        ...
        public CloudFoundry.WindowsPrison.Utilities.WindowsJobObjects.JobObject JobObject
        {
            get
            {
