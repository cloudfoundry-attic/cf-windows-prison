namespace CloudFoundry.WindowsPrison
{
    ...
    internal class PrisonGuard
    {
        ...
        {
            using (var guardJob = CloudFoundry.WindowsPrison.Utilities.WindowsJobObjects.JobObject.Attach(this.JobObjectName))
            {
            }
        }
        ...
        private static string GetGuardPath()
        {
            ...
            return Path.Combine(assemblyDirPath, "CloudFoundry.WindowsPrison.Guard.exe");
        }
    }
}
